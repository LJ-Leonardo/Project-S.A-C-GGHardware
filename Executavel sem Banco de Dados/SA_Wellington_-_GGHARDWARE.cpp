...
void excluirprodutoshardware() {
    ...
    fout.open("attproduto_hardware.csv", ios::out); // Cria um novo arquivo se ele não existir, neste caso temporariamente até que seja atualizado, backup.
    ...
    remove("produto_hardware.csv"); // Remove o arquivo
    rename("attproduto_hardware.csv", "produto_periferico.csv"); // Renomeia o aquivo temporario para o nome do arquivo principal com os dados atualizados.
...
void excluirprodutosperiferico() {
    ...
    fout.open("attproduto_periferico.csv", ios::out); // Cria um novo arquivo se ele não existir, neste caso temporariamente até que seja atualizado, backup.
    ...
    remove("produto_periferico.csv"); // Remove o arquivo
    rename("attproduto_periferico.csv", "produto_periferico.csv"); // Renomeia o aquivo temporario para o nome do arquivo principal com os dados atualizados.
...
/* login(); */ " "; // para desativar o modo usuário, comente essa opção
}
